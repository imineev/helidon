...
public interface MessagingClientProvider {
     ...
     *
     * @return provider name (such as {@code jms} or {@code mongo}
     */
    String name();

    /**
     * The implementation should provide its implementation of the {@link MessagingClientProviderBuilder}.
     *
     * @param <T> type of the builder
     * @return a new builder instance
     */
    <T extends MessagingClientProviderBuilder<T>> T builder();
}
