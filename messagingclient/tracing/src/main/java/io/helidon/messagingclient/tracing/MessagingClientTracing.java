 ...
 */
package io.helidon.messagingclient.tracing;
 ...
 */
public class MessagingClientTracing implements MessagingInterceptor {
    /**
     ...
     */
    public static MessagingClientTracing create(Config config) {
        return create();
    }
     ...
     * @return a new tracing interceptor
     */
    public static MessagingClientTracing create() {
        return new MessagingClientTracing();
    }
