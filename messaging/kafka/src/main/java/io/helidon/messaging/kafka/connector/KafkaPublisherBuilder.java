 ...
 */
public class KafkaPublisherBuilder<K, V> implements PublisherBuilder<KafkaMessage<K, V>> {

    private Consumer<Subscriber<? super KafkaMessage<K, V>>> publisher;

    public KafkaPublisherBuilder(Consumer<Subscriber<? super KafkaMessage<K, V>>> publisher) {
    ...
    public Publisher<KafkaMessage<K, V>> buildRs() {
        ...
        return new KafkaPublisher<K, V>(publisher);
    }
