 ...
 */
public class MessagingServiceBMC {
...
//        final String compartmentId = args[0];
        final String compartmentId  = "ocid1.compartment.oc1..aaaaaaaagf5galz7jxth4ef6m6zxk4lsvigpv7t7kox7gpthsp2irycptmka";

        final String exampleStreamName = "helidon-kafka-demo";
    ...
    private static void simpleMessageLoop(
        ...
        for (int i = 0; i < 10; i++) {
            ...
            for (Message message : getResponse.getItems()) {
                System.out.println("MessagingServiceBMC.simpleMessageLoop message:" + message);
//                System.out.println(
//                        String.format(
//                                "%s: %s",
